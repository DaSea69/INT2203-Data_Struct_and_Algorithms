...
public class PointSET {
    ...
    public Iterable<Point2D> range(RectHV rect) {
        ...
        return setPoints.parallelStream().filter(point -> rect.contains(point)).collect(Collectors.toList());
    }
    ...
    public Point2D nearest(Point2D point) {
        ...
        return setPoints.parallelStream().min(point.distanceToOrder()).get();
    }
